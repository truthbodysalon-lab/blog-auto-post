...
const NG_REPLACEMENTS = [
  ...
  [/100パーセント/g, '', '効果断定(100%)'],
  [/効果を保証(します)?/g, '変化を目指します', '効果断定(保証)'],
  [/効果を実感できます/g, '変化を感じていただける方もいらっしゃいます', '効果断定(実感保証)'],
  ...
  [/治れば/g, '楽になれば', '効果断定(治る)'],
  [/治る/g, '楽になる', '効果断定(治る)'],
  // 「治す」系(他動詞)も「治る」系(自動詞)と同じ医療的treatment断定なので、コンテンツクラスター側の
  // キーワード文字列(例:「大人の猫背 治し方」)にこの語が含まれていても検問で自動言い換えする。
  [/治し方/g, 'ケアの仕方', '医療的断定(治す)'],
  [/治せます/g, 'ケアを目指せます', '医療的断定(治す)'],
  [/治します/g, 'ケアします', '医療的断定(治す)'],
  [/治す/g, 'ケアする', '医療的断定(治す)'],
  [/100%/g, '', '効果断定(100%)'],
  // 「なくなります」はひらがな・漢字(無くなります)どちらの表記でも来るため両対応。
  [/が(な|無)くなりました/g, 'が軽くなることを目指せました', '効果暗示(なくなる)'],
  [/が(な|無)くなります/g, 'が軽くなることを目指せます', '効果暗示(なくなる)'],
  [/が(な|無)くなった/g, 'が軽くなることを目指した', '効果暗示(なくなる)'],
  [/が(な|無)くなる/g, 'が軽くなることを目指す', '効果暗示(なくなる)'],
  // 「もう〜に悩みません／二度と〜しません」的な、断言による完全解消の保証表現。
  [/二度と再発しません/g, '再発しにくい体づくりを目指します', '効果断定(再発しない)'],
  [/悩みません/g, '悩まされにくくなることを目指せます', '効果断定(悩みません)'],
  [/から解放されます/g, 'が楽になることを目指します', '効果暗示(解放)'],
  [/からの解放をサポート/g, 'を目指すお手伝いをします', '効果暗示(解放)'],
  [/から解放され/g, 'が楽になることを目指し', '効果暗示(解放)'],
  [/とサヨナラできます/g, 'と上手に付き合えることを目指します', '効果暗示(サヨナラ)'],
  [/とサヨナラ/g, 'との付き合い方の見直し', '効果暗示(サヨナラ)'],
  [/奇跡の/g, '', '誇大表現(奇跡)'],
  [/奇跡/g, '', '誇大表現(奇跡)'],
  [/万病に効きます/g, '', '効果断定(万病)'],
